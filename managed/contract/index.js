...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.submissionNonce) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named submissionNonce');
    }
    if (typeof(witnesses_0.answerHash) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named answerHash');
    }
    this.witnesses = witnesses_0;
    this.circuits = {
      submitExam: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`submitExam: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const expectedExamId_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('submitExam',
                                     'argument 1 (as invoked from Typescript)',
                                     'counter.compact line 28 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(expectedExamId_0.buffer instanceof ArrayBuffer && expectedExamId_0.BYTES_PER_ELEMENT === 1 && expectedExamId_0.length === 32)) {
          __compactRuntime.typeError('submitExam',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(expectedExamId_0),
      ...
      resetExam: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`resetExam: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const newExamId_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('resetExam',
                                     'argument 1 (as invoked from Typescript)',
                                     'counter.compact line 48 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(newExamId_0.buffer instanceof ArrayBuffer && newExamId_0.BYTES_PER_ELEMENT === 1 && newExamId_0.length === 32)) {
          __compactRuntime.typeError('resetExam',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'counter.compact line 48 char 1',
                                     'Bytes<32>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(newExamId_0),
            alignment: _descriptor_1.alignment()
          },
          output: undefined,
          publicTranscript: [],
    ...
    this.impureCircuits = {
      submitExam: this.circuits.submitExam,
      resetExam: this.circuits.resetExam,
  ...
  initialState(...args_0) {
    ...
    const initialExamId_0 = args_0[1];
    ...
    if (!(initialExamId_0.buffer instanceof ArrayBuffer && initialExamId_0.BYTES_PER_ELEMENT === 1 && initialExamId_0.length === 32)) {
    ...
    state_0.setOperation('submitExam', new __compactRuntime.ContractOperation());
    state_0.setOperation('resetExam', new __compactRuntime.ContractOperation());
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_8.toValue(1n),
                                                                                              alignment: _descriptor_8.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(initialExamId_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
  ...
  _submissionNonce_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.submissionNonce(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('submissionNonce',
                                 'return value',
  ...
  _answerHash_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.answerHash(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('answerHash',
                                 'return value',
  ...
  _submitExam_0(context, partialProofData, expectedExamId_0) {
  ...
  _resetExam_0(context, partialProofData, newExamId_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_8.toValue(1n),
                                                                                              alignment: _descriptor_8.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(newExamId_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return [];
  }
...
const _dummyContract = new Contract({
  ...
  submissionNonce: (...args) => undefined,
  answerHash: (...args) => undefined
});
